# TechVeo Database Terraform Project

Este projeto cria a infraestrutura AWS de banco para o TechVeo usando Terraform, incluindo uma instancia RDS SQL Server e dependencias de rede.
...
```powershell
cd "c:\Projetos\techveo-db-terraform"
```
...
- **DB Subnet Group** usando as subnets publicas do VPC principal
- **Security Group** para acesso ao banco
...
- **RDS SQL Server Express**: custos variam por tamanho de instancia
...
aws rds describe-db-instances --db-instance-identifier techveo-sqlserver --region us-east-1
```
